        ...
        <section className="pt-32 pb-20 px-4">
          <div className="container mx-auto text-center">
            ...
            duration: 0.6
              ...
              <img class="rounded-2xl shadow-2xl mx-auto max-w-4xl w-full" alt="CITIFIX platform dashboard showing civic issues" src="https://horizons-cdn.hostinger.com/a6afdcf9-aaa7-4281-ba79-be0f31c772d0/crowdsourced-civic-issue-reporting-and-resolution-PUaue.png" />
            </motion.div>
          </div>
        </section>
